        ...
        <div className="flex flex-wrap flex-col mx-auto gap-5 w-full lg:flex-row">
            {
                formFields.map((item, index) => (
                    <div key={index} className="w-full relative flex flex-col gap-2 lg:mx-auto lg:w-[550px]">
                        ...
                        </label>
                        {
                            item.type === 'select' ?
                                <div className="relative">
                                    <div className="border flex justify-between border-hijau rounded-2xl pl-7 pr-16 lg:pr-72 py-4 cursor-pointer"
                                    ...
                                    <div
                                        ...
                                        <ChevronDown size={30} strokeWidth={1.5} className="text-dark" />
                                    </div>
