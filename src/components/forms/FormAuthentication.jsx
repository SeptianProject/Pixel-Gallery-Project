...
const FormAuthentication = ({ formData, changeHandler, Data }) => {
        ...
        {formData.map((field, index) =>
          field.type === "select" ? (
            <div key={index} className="relative">
              <div
                className="border flex justify-between border-hijau rounded-xl pl-5 pr-16 lg:pr-72 py-3 cursor-pointer font-medium text-dark text-opacity-75"
